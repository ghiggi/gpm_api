...
center_lat = -17.489
center_lon = 56.181
c = drpy.graph.case_study(
    filename=io.filename[0][-64:], center_lat=center_lat, center_lon=center_lon
)
...
c.plotter_along(
    ...
    end_index=-25,
    scan=24,
    params_new={"y_max": 15, "z_vmin": 0, "z_vmax": 30},
)
c.plotter_along(
    start_index=25,
    end_index=-25,
    scan=24,
    params_new={"y_max": 15, "z_vmin": 0, "z_vmax": 30, "dfr_vmin": -1, "dfr_vmax": 5},
)
