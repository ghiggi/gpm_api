...
product_var_dict = {'2A-DPR': ["precipRateNearSurface"],
...
ax.plot(da['lon'][:, 0] + 0.0485, ds['lat'][:,0], color="white", linestyle="--", linewidth=0.2)

ax.plot(da['lon'][:,-1] - 0.0485, ds['lat'][:,-1], color="white", linestyle="--", linewidth=0.2)
