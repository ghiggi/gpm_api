...
variables = [
    "airTemperature",
    "precipRate","paramDSD", "zFactorFinal", "zFactorMeasured", 
...
transect_slices = get_transect_slices(ds, 
                                      direction=direction, 
                                      variable=variable, 
...
# Try good settings
p = da_profile.plot.pcolormesh(x=x_direction, y="height", vmin=-1, vmax=1, 
                               # norm = norm, 
                               cmap="RdBu_r")
plt.show()
...
p = da_profile.plot.pcolormesh(x=x_direction, y="height", 
