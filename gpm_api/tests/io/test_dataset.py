...
products = ['2A-DPR',"2A-Ka", '2A-ENV-DPR',
            "1B-Ka", "1B-Ku", '1C-GMI', '2A-GMI',
            '2B-GPM-CORRA', '2B-GPM-CSH', '2A-GPM-SLH']
...
products = ['2A-DPR',"2A-Ka", '2A-ENV-DPR',
            "1B-Ka", "1B-Ku", '1C-GMI', '2A-GMI',
            '2B-GPM-CORRA', '2B-GPM-CSH', '2A-GPM-SLH']
products = ["2B-TRMM-CORRA","2B-TRMM-CSH", "2A-TRMM-SLH",
            "1B-TMI", "1C-TMI", "2A-ENV-PR", "2A-PR"]
