...
from gpm.io.download import curl_pps_cmd, download_archive, run, wget_pps_cmd

####-------------------------------------------------------------------------.
#### Test gpm.download function
product = "2A-DPR"
product_type = "RS"
...
from gpm.io.download import get_filepaths_from_filenames, filter_download_list
