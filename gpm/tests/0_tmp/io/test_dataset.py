...
products = gpm.available_products(product_categories="CMB")
products = gpm.available_products(product_categories="IMERG")
products = gpm.available_products(product_categories="RADAR")
products = gpm.available_products(product_categories="PMW")
