...
class Xradar_Dev_Base_Accessor:
    ...
    def resolution_at_range(self, azimuth_beamwidth, elevation_beamwidth):
        from gpm.xradar.methods import resolution_at_range
    ...
    def extent(self, max_distance=None, crs=None):
        from gpm.xradar.methods import get_extent

        return get_extent(self._obj, max_distance=max_distance, crs=crs)

    def quadmesh(self):
        from gpm.xradar.methods import get_quadmesh

        return get_quadmesh(self._obj)

    def vertices(self, ccw=True):
        from gpm.xradar.methods import get_vertices
    ...
    def plot_range_distance(
        ...
        **plot_kwargs,
        ...
        from gpm.xradar.methods import plot_range_distance
...
class Xradar_Dev_DataArray_Accessor(Xradar_Dev_Base_Accessor):
    ...
    def plot_map(
        ...
        **plot_kwargs,
        ...
        from gpm.xradar.methods import plot_map
...
class Xradar_Dev_Dataset_Accessor(Xradar_Dev_Base_Accessor):
    ...
    def to_geopandas(self, dim_order=None):
        from gpm.xradar.methods import to_geopandas
